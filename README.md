...
To run a pool, you must use this along with the main branch of `chia-rosechain`.

1. Checkout the `main` branch of `chia-rosechain`, and install it. Checkout this repo in another directory next to (not inside) `chia-rosechain`.  
